...
const StudentSidenav = (props) => {
  ...
  return (
    <Menu inverted vertical className="studentSidenav">
      <Menu.Item id="student-sidenav-info"><Image id="student-avatar" src={props.studentLoginInfo.gravatar_url ? props.studentLoginInfo.gravatar_url : props.studentLoginInfo.photo_url} shape="circular" size="tiny" centered />
